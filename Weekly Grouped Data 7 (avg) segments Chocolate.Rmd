...
```{r}
acf(df_regression$count, lag.max = 100,main = "ACF of count")
pacf(df_regression$count, lag.max = 100, main = "PACF of count")
...
####Newey West Method
```{r}
NW <- NeweyWest(seg_model,lag=25,prewhite =F,adjust=T)
NW_se <- sqrt(diag(NW))
print(NW_se)
