---
title: "Chocolate GLS Model with weekly grouping"
...
df_weekly <- df_filtered %>%
  ...
  summarize(
    ...
    intervention = first(intervention),
     post_intervention=first(post_intervention),
    .groups = "drop"
  )
...
```{r}
gls_model <- gls(difference ~ t + intervention , 
                 data = df_regression,
